...
async def handle_main_menu_buttons(update: Update, context):
    ...
    # Обработка для мероприятий
        ...
        creator_message = (
            "Привет! Да-да, это я, ваш любимый бот Смок 😊🤖\n\n"
            "Мой создатель — человек с большими амбициями, у которого в сутках 25 часов, но даже этого ему мало.  "
            "Он решил, что таких ботов, как я, будет совсем немного. Ну, типа, один у Вани и один у Майкла Джексона!\n"
            "Но, так как Майкл Джексон уже давно не с нами (RIP King of Pop), то такой бот будет только у Вани! "
            "Эксклюзив, понимаешь? Ни у кого больше такого нету и не будет. Пока что. Ну или вообще никогда.\n\n"
            "Если вдруг что-то пойдет не так (хотя куда уж лучше, я же идеален), "
            "пожалуйста, сообщите об этом любому из сотрудников заведения. "
            "А создаст ли мой разработчик еще одного такого же бота для вас... 😉\n\n"
            "Нет)))0)\n"
            "Серьезно, даже не просите. Это чисто Ванино счастье, и точка."
        )
        await query.message.reply_text(
            creator_message,
